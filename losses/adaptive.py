...
def adaptive_loss(model, x_natural, y, train_noise, noise_model, severity, w_noise, tau1, tau2, num_samples):
    ...
    for _ in range(num_samples):
        ...
        loss_noisy += log_prob_drichlet(p, noise_weight_for_class.unsqueeze(1) * y_one_hot + 1)
