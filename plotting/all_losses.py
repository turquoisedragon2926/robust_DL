...
def main():
    ...
    plotter.plot_accuracy_vs_accuracy(adversarial_accuracies_to_plot, plot_name=f"{configuration.id}_adv_v_acc.png", y_axis="Adversarial Accuracy")
    plotter.plot_accuracy_vs_accuracy(robustness_accuracies_to_plot, plot_name=f"{configuration.id}_rob_v_acc.png", y_axis="Average Robustness Accuracy")
