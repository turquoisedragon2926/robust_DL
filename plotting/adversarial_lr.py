...
def main():
    ...
    for lr in lrs:
        ...
        plotter.plot_severity_vs_robustness(alphas, natural_accuracies, robustness_accuracies, lr, plot_name=f"{configuration.id}_alpha_vs_robustness_lr_ce.png", metric="Alpha")
        plotter.plot_eval_noise_bar_chart(eval_noises, alpha_accuracies, lr, plot_name=f"{configuration.id}_noise_vs_robustness_lr_ce.png", metric="Alpha")
    
    plotter.plot_combined_severity_vs_robustness(alphas, total_robustness_accuracies, lrs, plot_name=f"{configuration.id}_combined_alpha_vs_robustness_lr_ce.png", metric="Alpha")
    plotter.plot_combined_severity_vs_robustness(alphas, total_natural_accuracies, lrs, plot_name=f"{configuration.id}_combined_alpha_vs_natural_lr_ce.png", robust=False, metric="Alpha")

    plotter.plot_tradeoff(alphas, total_natural_accuracies, total_robustness_accuracies, plot_name=f"{configuration.id}_alpha_tradeoff_ce.png")
