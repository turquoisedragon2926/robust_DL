...
def parse_args():
    ...
    parser.add_argument('--train_dataset', type=str, default="cifar10", choices=['cifar10', 'cifar100', 'augcifar10', 'augcifar100', 'imagenet'], help='Training Dataset type(default: cifar10)')
    parser.add_argument('--eval_dataset', type=str, default="cifar10C", choices=['cifar10C', 'cifar100C', 'imagenetC'], help='Evaluation Dataset type (default: cifar10C)')
    parser.add_argument('--loss_type', type=str, default="adaptive", choices=['trades', 'adaptive', 'ce', 'adversarial', 'augmix'], help='Loss type: trades / custom / ce / adversarial')
